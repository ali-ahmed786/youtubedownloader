...
def download2(request):
    try:
      ...
      return render(request, "downloader/final_Step.html", {
        ...
        return render(request, "downloader/index.html", {
               "message": "There's been an issue😣😣! Please start again 😄😄"
          })
...
def download3(request):
    try:
      ...
      if video_res!="None":
        ...
        return render(request, "downloader/index.html", {
               "message": "There's been an issue😣😣! This might be because you selected none  as resolution. Please start again 😄😄"
          })
